...
var accountsAPIV1_0 = require('../routes/accounts-api-v1.0')
var activityAPIV1_0 = require('../routes/activity-api-v1.0')

module.exports = WebApp

function WebApp (db, opts) {
  if (!(this instanceof WebApp)) return new WebApp(db, opts)
  opts = opts || { site: { title: 'Township' } }
  var self = this
  ...
  this.activity = require('./activity')(db)
  ...
  */
  ...
  accounts(this)
  accountsAPIV1_0(this)
  activityAPIV1_0(this)
}
